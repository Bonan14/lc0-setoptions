...
set OPENCL_LIBS=C:\Program Files (x86)\IntelSWTools\system_studio_2020\OpenCL\sdk\lib\x64
set OPENCL_INCS=C:\Program Files (x86)\IntelSWTools\system_studio_2020\OpenCL\sdk\include
set ONNX_PATH=C:\Users\cenam\Documents\Microsoft.ML.OnnxRuntime.OpenVino.1.18.0-dev
...
meson setup build --backend %backend% --buildtype release -Ddx=%DX12% -Dcudnn=%CUDNN% -Dplain_cuda=%CUDA% -Dblas=%BLAS% -Dmkl=%MKL% ^
...
-Donednn=false -Dpext=true -Dispc=true -Dispc_native_only=false -Ddnnl=true -Dmkl_include="%MKL_PATH%\include" ^
